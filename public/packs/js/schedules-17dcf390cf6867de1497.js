...
/* WEBPACK VAR INJECTION */(function($) {!(function webpackMissingModule() { var e = new Error("Cannot find module 'fullcalendar'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//  $(function () {
...
$(document).ready(function () {
  ...
  var calendar = $('#calendar').fullCalendar({
    ...
    // スケジュールをスナップするときの動かせる細かさ
    minTime: "00:00:00",
    // スケジュールの開始時間
    maxTime: "24:00:00",
    // スケジュールの最終時間
    defaultTimedEventDuration: '10:00:00',
    // 画面上に表示する初めの時間(スクロールされている場所)
    allDaySlot: false,
    // 終日スロットを非表示
    allDayText: 'allday',
    // 終日スロットのタイトル
...
/******/ });
//# sourceMappingURL=schedules-17dcf390cf6867de1497.js.map