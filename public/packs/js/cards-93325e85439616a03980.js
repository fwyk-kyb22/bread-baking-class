...
/* WEBPACK VAR INJECTION */(function($) {document.addEventListener("DOMContentLoaded", function (e) {
  //DOM読み込みが完了したら実行
    ...
    btn.addEventListener("click", function (e) {
      ...
      Payjp.createToken(card, function (status, response) {
        ...
        if (status === 200) {
          ...
          $("#card_token").append($('<input type="hidden" name="payjp-token">').val(response.id)); //取得したトークンを送信できる状態
...
/******/ });
//# sourceMappingURL=cards-93325e85439616a03980.js.map